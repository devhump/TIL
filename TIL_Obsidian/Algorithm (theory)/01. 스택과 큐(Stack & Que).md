...
![](assets/01_stack&que_img-%20(1).png)

- 작동방식1 (삭제 이전까지)
![](assets/01_stack&que_img-%20(2).png)

- 작동방식2 (모든 동작이 완료 후)
![](assets/01_stack&que_img-%20(3).png)
...
![](assets/01_stack&que_img-%20(4).png)

-  큐는 입구와 출구가 모두 뚫려 있는 터널과 같은 형태로 시각화 할 수 있습니다. 

- 작동방식1 (최초 삭제 실행 이전 상태)
![](assets/01_stack&que_img-%20(5).png)

- 작동방식2 (모든 연산이 종료된 후)
![](assets/01_stack&que_img-%20(6).png)
