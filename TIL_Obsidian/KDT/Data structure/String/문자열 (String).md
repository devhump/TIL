...
- 목차
	[1. 문자열 슬라이싱](#1.%20문자열%20슬라이싱)
	[2. 문자열 메서드](#2.%20문자열%20메서드)
	[3. 아스키(ASCII) 코드](#3.%20아스키(ASCII)%20코드)
...
![](assets/Pasted%20image%2020230217143352.png)
...
![](assets/Pasted%20image%2020230217144524.png)
...
![](assets/Pasted%20image%2020230217145144.png)
...
- 문자열 메서드 연습
	- [BOJ_17249 태보태보 총난타](https://www.acmicpc.net/problem/17249)
